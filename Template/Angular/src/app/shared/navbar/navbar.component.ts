...
export class NavbarComponent implements OnInit {
    ...
    minimizeSidebar() {
        ...
        if (this.sidebar_mini_active === true) {
            ...
            console.log("if true = " + this.sidebar_mini_active)

        } else {
            // setTimeout(function () {
            body.classList.add('sidebar-mini');
            this.sidebar_mini_active = true;
            console.log("if false = " + this.sidebar_mini_active)
            // }, 300);
        }
        ...
        // this.sidebar_mini_active = true;
        console.log("status: " + this.sidebar_mini_active)
